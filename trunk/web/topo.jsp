<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
   <td colspan="16"><img name="layoutecommerce_r1_c1" src="img/layout-ecommerce_r1_c1.png" width="700" height="11" border="0" id="layoutecommerce_r1_c1" alt="" /></td>
   <td><img src="img/spacer.gif" width="1" height="11" border="0" alt="" /></td>
  </tr>
  <tr>
   <td rowspan="4"><img name="layoutecommerce_r2_c1" src="img/layout-ecommerce_r2_c1.png" width="13" height="98" border="0" id="layoutecommerce_r2_c1" alt="" /></td>
   <td rowspan="3" colspan="3"><img name="logo" src="img/logo.png" width="152" height="77" border="0" id="logo" alt="" /></td>
   <td rowspan="4"><img name="layoutecommerce_r2_c6" src="img/layout-ecommerce_r2_c6.png" width="10" height="98" border="0" id="layoutecommerce_r2_c6" alt="" /></td>
   <td rowspan="4" colspan="3"><img name="foto" src="img/foto.png" width="203" height="98" border="0" id="foto" alt="" /></td>
   <td rowspan="4"><img name="layoutecommerce_r2_c10" src="img/layout-ecommerce_r2_c10.png" width="9" height="98" border="0" id="layoutecommerce_r2_c10" alt="" /></td>
   <td colspan="3" bgcolor="#6CAA00">            <form action="index.jsp" method="get">
                Pesquisa:
                ...
                <input type="hidden" name="pProduto"
                       value="<% if (request.getParameter("pProduto")!=null) { out.print(request.getParameter("pProduto")); } else { out.print(1); } %>" />
                <input type="hidden" name="pNivel"
                       value="<% if (request.getParameter("pNivel")!=null) { out.print(request.getParameter("pNivel")); } else { out.print(1); } %>" />
                <input type="submit" value="Ok" class="pesquisa"/>
            </form>
</td>
   <td colspan="2"><img name="layoutecommerce_r2_c14" src="img/layout-ecommerce_r2_c14.png" width="19" height="48" border="0" id="layoutecommerce_r2_c14" alt="" /></td>
   <td rowspan="4" colspan="2"><img name="layoutecommerce_r2_c16" src="img/layout-ecommerce_r2_c16.png" width="7" height="98" border="0" id="layoutecommerce_r2_c16" alt="" /></td>
   <td><img src="img/spacer.gif" width="1" height="48" border="0" alt="" /></td>
  </tr>
  <tr>
   <td colspan="5"><img name="layoutecommerce_r3_c11" src="img/layout-ecommerce_r3_c11.png" width="306" height="9" border="0" id="layoutecommerce_r3_c11" alt="" /></td>
         ...
         <center>
                <%
                            if (session.getAttribute("UsuarioLogado") != null) {
                                ...
                                out.print("<a href='novousuario.jsp'>Novo Usuário</a>");
                            }
                %>
            </center>
   </td>
