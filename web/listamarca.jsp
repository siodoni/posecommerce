...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt-br" lang="pt-br">
    <head>
        ...
        <script language="javascript" type="text/javascript">
            function excluir(pMarca) {
                if (confirm("Confirma a exclusão do registro?")) {
                    document.location.href = "excluirmarca.jsp?pMarca=" + pMarca;
                }
            }
        </script>
    </head>
    <body>
        ...
        <h1 align="center">Cadastro de Marcas</h1>
        <br/>
        <table width="80%" align="center">
            <tr>
                <td width="" class="titulo">Descrição</td>
            ...
            <%
                        ...
                        while (rs.next()) {
                            ...
                            out.println("<a href=\"editarmarca.jsp?pMarca=" + rs.getInt(2) + "\"><img src=\"img/editar.png\" alt=\"editar\"/></a>");
                            out.println("</td>");
                            out.println("<td class=\"" + css + "\" align=\"center\">");
        ...
        <br/>
        <center>
            <a href="editarmarca.jsp?pMarca=0">Incluir</a>
            &nbsp;|&nbsp;
